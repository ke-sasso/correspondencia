            ...
            <form role="form" id="search-form">
               <div class="row">
                    <div class="form-group col-sm-5 col-xs-12 col-md-6 col-lg-6">
                        <label>Seleccione un titular:</label>
                        <select name="idTitular" id="idTitular" class="form-control select_plaza js-states" 
                             style="width: 100%;" >
                              <option></option>
                        </select>
                        <select class="js-source-states" style="visibility: hidden">
                          @foreach($tit as $t)
                                <option value="{{$t->idTitular}}">
                                  {{$t->nombreTitular}}
                                </option>
                            @endforeach
                        </select>
               ...
               <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-xs-6">
                        ...
                        <select name="idEstado" id="idEstado" class="form-control select_plaza2 js-states2" 
                             style="width: 100%;" >
                              <option></option>
                        </select>
                        <select class="js-source-states2" style="visibility: hidden">
                              ...
                              <option value="11">OBSERVADA</option>
                        </select>    
                    </div>
                       <div class="form-group col-sm-6 col-xs-6">
...
$(document).ready(function(){
    ...
    var $states2 = $(".js-source-states2");
      ...
      table = $('#dt-solicitudes').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('get.pendientes.participante') }}",
             data: function (d) {
         ...
         columns: [
          ...
          {data: 'fechaDetalle', name: 'fechaDetalle'},
          {data: 'dias', name: 'dias'},
          {data: 'diasproceso', name: 'diasproceso'},
