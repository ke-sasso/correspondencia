            ...
            <form role="form" id="search-form">
               <div class="row">
                    <div class="form-group col-sm-5 col-xs-12 col-md-6 col-lg-6">
                        ...
                        <select name="idEmpleado" id="idEmpleado" class="form-control select_plaza js-states" 
                             style="width: 100%;" >
                              <option></option>
                        </select>
                        <select class="js-source-states" style="visibility: hidden">
                         @foreach($empleados as $e)
                          <option value="{{$e->idEmp}}">{{$e->nombresEmpleado}} {{$e->apellidosEmpleado}}</option>
                         @endforeach
                        </select>
                    </div>
...
<div class="the-box" style="display: none;" id="tabla-reporte">
...
$(document).ready(function(){
    ...
    var $states2 = $(".js-source-states2");
      ...
      table = $('#dt-solicitudes').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('get.reporte.pendientes.participante') }}",
             data: function (d) {
                d.idEmpleado= $('#idEmpleado').val();
