        ...
        @include('denuncia.panel.detalleRecepcion')
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-addon"><b>MOTIVO</b></div>
                     <div class="form-group">
                        <textarea name="descripcion" id="descripcion" class="summernote-sm"><?php echo strip_tags($info->descripcion);?></textarea>                                        
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-3">
                     ...
                     <input type="number" min="0" max="99" maxlength="2" class="form-control cel_masking" id="edad" name="edad" autocomplete="off" value="{{$detalle->edad}}" >
                    </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-12">
                     <div class="input-group ">
                      ...
                      <input type="text" class="form-control" id="profesion" name="profesion" autocomplete="off" value="{{$detalle->profesion}}">
                    </div>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                          ...
                          @if(trim($detalle->tipoDoc)=='DUI')
                           <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="N1">
                                    ...
                                    <input type="text" class="form-control dui_masking" id="numDocumentoP" name="numDocumentoP" autocomplete="off" value="{{$detalle->noDocumento}}">
                                    </div>
                             </div>
                             <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="N2" style="display: none;">
                                    <div class="input-group">
                                    <div class="input-group-addon"><b># Documento</b></div>
                                    <input type="text" class="form-control" id="numDocumento2" maxlength="30" name="numDocumento2" autocomplete="off" value="{{$detalle->noDocumento}}">
                                    </div>
                               </div> 
                          @else
                 ...
                 <div class="form-group">
                    ...
                    <div class="input-group-addon"><b>Ofrece de prueba:</b></div>
                     <div class="form-group">
                        <textarea name="prueba" id="prueba" class="summernote-sm"><?php echo strip_tags($detalle->ofrecePrueba);?></textarea>                                        
                        </div>
                    </div>
                    </div>
                </div>
                  <div class="form-group">
                    ...
                    <div class="input-group-addon"><b>Por lo antes mencionado PIDE:</b></div>
                     <div class="form-group">
                        <textarea name="pide" id="pide" class="summernote-sm"><?php echo strip_tags($detalle->pide);?></textarea>                                        
                        </div>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 col-md-12">
                     <div class="input-group ">
                      ...
                      <input type="text" class="form-control" id="aviso" name="aviso" value="{{$detalle->aviso}}" autocomplete="off" >
                    </div>
                    </div>
        ...
        $('body').modalmanager('loading');
          ...
          success:  function (response){
            ...
            if(isJson(response)){
             ...
             // alert(obj.list);
              if(no>0){
              alertify.alert("Mensaje de Sistema","<strong><p class='text-justify'>¡INFORMACIÓN EDITADA CON EXITO!: "+obj.list+"</p></strong>",function(){
                   location.reload();      
...
$(document).on('click','.ckb-check4',function(e) {
 ...
 $('#panelEstablecimientos').modal('hide');
  ...
  //document.getElementById('cont-tit').style.display = 'block';
    ...
    $('#list-Productos').append('<tr><td><input type="hidden" name="proSi[]" value="'+dataAddProSi[i][0]+'" >'+dataAddProSi[i][1]+'</td><td>'+dataAddProSi[i][4]+'</td><td>'+dataAddProSi[i][2]+'<td>'+dataAddProSi[i][3]+'</td></td><td><a class="btn btn-xs btn-danger btn-perspective btnEliminar"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>');
