               ...
               <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-xs-6">
                      ...
                      <div class="form-group col-sm-6 col-xs-6">
                        <label>Estado:</label>
                        <select name="idEstado"  id="idEstado" class="form-control" placeholder="Escriba el número de presentación de la solicitud"   autocomplete="off">
                        <option value="" selected>Seleccione un estado...</option>
                        <option value="1">INGRESADAS</option>
                        <option value="3">EN PROCESO</option>
                        <option value="12">CASO CERRADO</option>
                        <option value="13">DENUNCIA PROCEDE</option>
                        <option value="14">DENUNCIA NO PROCEDE</option>
                        <option value="15">DENUNCIA EN REVISIÓN</option>
                        <option value="16">SEIPS</option>
...
var table;
    function limpiarFormulario(){
        window.location = "{{route('lista.denuncia.archivadas')}}";            
    }
...
$(document).ready(function(){
    ...
    var $states2 = $(".js-source-states2");
      ...
      table = $('#dt-solicitudes').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('get.denuncia.solicitudes.archivadas') }}",
             data: function (d) {
